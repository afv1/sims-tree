...
func (uc *UserCreate) AddFamilyIDs(ids ...int) *UserCreate {
	uc.mutation.AddFamilyIDs(ids...)
	return uc
}

// AddFamilies adds the "families" edges to the Family entity.
func (uc *UserCreate) AddFamilies(f ...*Family) *UserCreate {
	ids := make([]int, len(f))
	for i := range f {
		ids[i] = f[i].ID
	}
	return uc.AddFamilyIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.FamiliesIDs(); len(nodes) > 0 {
