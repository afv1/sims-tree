...
func (e UserEdges) FamiliesOrErr() ([]*Family, error) {
	if e.loadedTypes[0] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldLogin, user.FieldPassword, user.FieldComment:
...
// QueryFamilies queries the "families" edge of the User entity.
func (u *User) QueryFamilies() *FamilyQuery {
	return (&UserClient{config: u.config}).QueryFamilies(u)
}
